package com.example.weatherm.api;
...
public class HttpConnection {
    ...
    /** 웹 서버로 요청을 한다. */
    public void requestWebServer(String city, Callback callback) {
...
//                .addEncodedQueryParameter("APPID", "10465524bfe7eaa71c4010cb81b84a11")
//                .build();
